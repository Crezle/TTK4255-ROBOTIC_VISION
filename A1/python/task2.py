...
plt.suptitle("Task 2.2, Single Channel Colors")
...
plt.suptitle("Task 2.3, Thresholding Single Channel")
...
plt.suptitle("Task 2.4, Normalization of RGB Image")
...
plt.suptitle("Task 2.5, Normalized Thresholding Single Channel")
